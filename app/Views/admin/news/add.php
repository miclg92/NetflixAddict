		...
		<div id="add-news">
			<form method="post" class="form" enctype="multipart/form-data">
				...
				<div class="text-center">
					<button id="add_news_btn" type="submit" class="btn btn-default" aria-hidden="true"><i
								class="fas fa-plus" aria-hidden="true"></i> Publier
					</button>
					<a href="index.php?p=admin.news.index" type="button" id="add_news_btn" type="submit" class="btn"
