...
if (isset($_SESSION['auth']) && isset($_SESSION['user']) && $_SESSION['user']->flag == 2) {
	?>
	<div id="bloc_content">
		<div id="edit_quiz_answer" class="form">
			<form method="post" action="">
				<a href="index.php?p=admin.quiz.answers" type="button" class="close" data-dismiss="modal"
				...
				<div class="form-group">
					<label for="correct">Est la bonne réponse ? (oui=1/non=0)</label>
					<input type="text" name="correct" id="correct" value="<?= $answer->is_correct; ?>"
					       class="form-control">
				</div>
				<hr>
				<div class="text-center">
					...
					<a href="index.php?p=admin.quiz.answers" type="button" id="login_form_btn" class="btn"
