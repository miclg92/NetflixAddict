...
if (isset($_SESSION['auth']) && isset($_SESSION['user']) && $_SESSION['user']->flag == 2) {
	?>
	<div id="bloc_content">
		<div id="edit_test_question" class="form">
			<form method="post" action="">
				<a href="index.php?p=admin.test.questions" type="button" class="close" data-dismiss="modal"
				...
				<div class="text-center">
					...
					<a href="index.php?p=admin.test.questions" type="button" id="login_form_btn" class="btn"
