	...
	<div id="bloc_content">
		<div id="add_categories" class="form">
			<form method="post" action="">
				<a href="index.php?p=admin.newsCategories.index" type="button" class="close" data-dismiss="modal"
				...
				<div class="text-center">
					<button id="add_categories_btn" type="submit" class="btn btn-default" aria-hidden="true"><i
								class="fas fa-plus" aria-hidden="true"></i> Ajouter
					</button>
					<a href="index.php?p=admin.newsCategories.index" type="button" id="login_form_btn" class="btn"
