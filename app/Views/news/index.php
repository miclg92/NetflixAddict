...
<div id="bloc_content">
	...
	<div id="bloc_news_list">
		<div id="all_news" class="row">
			<?php foreach($news as $new): ?>
				<div class="row each_news">
					<div class="col-xs-12">
						<a class="col-xs-offset-2 col-xs-8" href="<?= $new->url ?>">
							<img class="col-xs-offset-1 col-xs-10 col-sm-offset-3 col-sm-6 col-md-offset-2 col-md-8 thumbnail" src="<?= $new->image ?>" alt="<?= $new->image_name ?>">
						</a>
					</div>
					<div class="col-md-12">
