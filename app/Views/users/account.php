			...
			if ($_SESSION['user']->flag == 1) {
				...
				<table class="table">
					...
					<tr>
						...
						<td><a class="btn" href="?p=users.editName&id=<?= $_SESSION['auth']; ?>"><i class="fa fa-pencil"
						                                                                            aria-hidden="true"></i>
								Modifier</a></td>
					</tr>
					<tr>
						...
						<td><a class="btn" href="?p=users.editMail&id=<?= $_SESSION['auth']; ?>"><i class="fa fa-pencil"
						                                                                            aria-hidden="true"></i>
								Modifier</a></td>
					</tr>
					<tr>
						...
						<td><a class="btn" href="?p=users.requestedPasswd&id=<?= $_SESSION['auth']; ?>"><i
										class="fa fa-pencil" aria-hidden="true"></i> Modifier</a></td>
					</tr>
					<tr>
						<td class="param"><i class="fa fa-film" aria-hidden="true"></i> Mes séries favorites :</td>
						<td class="param_value"></td>
						<td><a class="btn" href="?p=series.favorites"><i class="fa fa-pencil" aria-hidden="true"></i>
								Gérer</a></td>
					</tr>
					<tr>
						<td></td>
				...
				<table class="table">
					...
					<tr>
						...
						<td><a class="btn" href="?p=admin.news.index"><i class="fa fa-pencil" aria-hidden="true"></i>
								Gérer</a></td>
					</tr>
					<tr>
						<td class="param"><i class="fa fa-window-restore" aria-hidden="true"></i> Gestion des Catégories
							d'actus :
						</td>
						<td><a class="btn" href="?p=admin.newsCategories.index"><i class="fa fa-pencil"
						                                                           aria-hidden="true"></i> Gérer</a>
						</td>
					</tr>
					<tr>
						<td class="param"><i class="fa fa-commenting-o" aria-hidden="true"></i> Gestion des Commentaires
							:
						</td>
						<td><a class="btn" href="?p=admin.comments.index"><i class="fa fa-pencil"
						                                                     aria-hidden="true"></i> Gérer</a></td>
					</tr>
					<tr>
						<td class="param"><i class="fa fa-trophy" aria-hidden="true"></i> Gestion du Quiz :</td>
						<td><a class="btn" href="?p=admin.quiz.index"><i class="fa fa-pencil"
						                                                 aria-hidden="true"></i> Gérer</a></td>
					</tr>
					<tr>
						<td class="param"><i class="fa fa-question-circle" aria-hidden="true"></i> Gestion du Test :
						</td>
						<td><a class="btn" href="?p=admin.test.index"><i class="fa fa-pencil"
						                                                 aria-hidden="true"></i> Gérer</a></td>
					</tr>
					<tr>
						<td class="param"><i class="fa fa-film" aria-hidden="true"></i> Séries disponibles :</td>
						<td><a class="btn" href="?p=admin.series.index"><i class="fa fa-spinner" aria-hidden="true"></i>
								Actualiser</a></td>
					</tr>
					<tr>
						<td></td>
			...
			<form method="post" class="form row">
				<div class="text-center col-xs-12">
					<a class="btn" id="delete_account_btn" href="?p=users.askPasswdBeforeDelete"><i
								class="fa fa-trash-o" aria-hidden="true"></i> Supprimer mon compte</a>
